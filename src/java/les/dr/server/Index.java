...
import les.dr.server.pages.IndexPage;
...
public class Index extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         Utilizador ut = new Utilizador("email"), ures;
         ures = uts.find(ut);
         if(ures!=null && passwd.equals(ures.getPassword())){
        ...
        try (PrintWriter out = response.getWriter()) {
            Page pag = new LoginPage(out, "Autenticação falhou");
            pag.genPage();
                }
         }
